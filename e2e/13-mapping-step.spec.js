...
test.describe("Step 12: PLO to MIMLO Mapping", () => {
  test.beforeEach(async ({ page }) => {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      await page.getByTestId(/^plo-textarea-/).last().fill(`PLO ${i + 1}: Test learning outcome`);
      await page.waitForTimeout(200);
    }
    await page.waitForTimeout(500);
    ...
    await page.waitForTimeout(300);
    await page.getByTestId(/^module-code-/).first().fill("MOD1");
    await page.getByTestId(/^module-title-/).first().fill("Module 1");
    ...
    // Fill second module
    await page.getByTestId(/^module-code-/).nth(1).fill("MOD2");
    await page.getByTestId(/^module-title-/).nth(1).fill("Module 2");
    await page.getByTestId(/^module-credits-/).nth(1).fill("10");
    await page.waitForTimeout(500);
