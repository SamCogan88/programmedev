      ...
      <h2 className="accordion-header" id={headingId}>
        ...
        >
          <div className="d-flex w-100 align-items-center gap-2">
            <div className={subtitlePosition === "right" ? "d-flex w-100 align-items-center justify-content-between" : "flex-grow-1"}>
...
export function HeaderAction({
  ...
  return (
    <span
      ...
      {...dataProps}
    >
      {icon && <i className={`ph ph-${icon}${label ? " me-1" : ""}`} aria-hidden="true" />}
      {label}
    </span>
  );
}
