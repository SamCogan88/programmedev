  ...
  return (
    <div className="mimlo-lint-warnings mt-1" role="status" aria-live="polite">
      {warnings.map((issue, idx) => (
        <div key={idx} className="alert alert-warning py-1 px-2 mb-0 mt-1 small">
...
export const MimlosStep: React.FC = () => {
  ...
  return (
    <Card className="shadow-sm">
      <Card.Body>
        <h5 className="card-title mb-3" id="mimlos-heading">
          <Icon name="graduation-cap" className="me-2" aria-hidden />
          MIMLOs (Minimum Intended Module Learning Outcomes)
        </h5>
