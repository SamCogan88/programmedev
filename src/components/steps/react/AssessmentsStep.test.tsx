...
describe("AssessmentsStep", () => {
  ...
  describe("Report Controls", () => {
    ...
    it("should have show inline button", () => {
      render(<AssessmentsStep />);
      expect(screen.getByTestId("run-report-inline")).toBeInTheDocument();
    });

    it("should have new tab button", () => {
      render(<AssessmentsStep />);
      expect(screen.getByTestId("run-report-newtab")).toBeInTheDocument();
    });

    it("should show report when Show below is clicked", async () => {
      render(<AssessmentsStep />);
