...
/**
 * Sankey diagram placeholder message.
 * The actual Sankey diagram requires Plotly which isn't easily rendered in React.
 */
const SankeyDiagramPlaceholder: React.FC<{ hasData: boolean }> = ({ hasData }) => {
  if (!hasData) {
    return (
  ...
  return (
    <div className="mb-2">
      <div className="small text-secondary mb-2">
        Flow diagram showing alignments from Award Standards through to Assessments. Hover over
        nodes and links for details.
      </div>
      ...
      <Tab.Container defaultActiveKey="table">
        ...
        <Tab.Content>
          ...
          <Tab.Pane eventKey="sankey">
            <SankeyDiagramPlaceholder hasData={allRows.length > 0} />
          </Tab.Pane>
        </Tab.Content>
      </Tab.Container>
