    ...
    <Card className="shadow-sm">
      <Card.Body>
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h5 className="card-title mb-0" id="modules-heading">
            <Icon name="cube" className="me-2" aria-hidden />
            Credits & modules (QQI-critical)
          </h5>
          <button
        ...
        <Alert variant="light" role="note" className="mb-3">
